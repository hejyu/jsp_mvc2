...
import day6.mvc.controller.MemberListController;
...
import day6.mvc.controller.ProductAddController;
...
public class RequestControllerMapping {
	...
	//Map 의 Key는 url, methodd 로 구성된 객체,  Value는 Controller 
	...
	public static void init() {
        ...
        mapping.put(new RequestMap("/product/add","GET"), new ProductAddController());
        mapping.put(new RequestMap("/product/add","POST"), new ProductAddController());
        ...
        mapping.put(new RequestMap("/cart/list","GET"), new CartController());
        mapping.put(new RequestMap("/product/list","GET"), new ProductListController());
	}
